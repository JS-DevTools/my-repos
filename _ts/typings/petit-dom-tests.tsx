...
export function testHtmlElementWithTextContent() {
  ...
  let aNode = h("a", { href: "link", onclick: eventHandler }, "click here");
  ...
  let jsxNode = <a href="link" onclick={eventHandler}>click here</a>;
  let jsxNodeType = jsxNode.type as string;
  let jsxNodeProps = jsxNode.props as PetitDom.Props<HTMLAnchorElement>;
...
export function testHtmlElementWithMixedContent() {
  ...
  // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
  let jsxNode = <form key={1} method="POST" onsubmit={eventHandler}>Hello <span>World</span></form>;
  let jsxNodeType = jsxNode.type as string;
  let jsxNodeProps = jsxNode.props as PetitDom.Props<HTMLFormElement>;
...
export function testSvgElementWithChild() {
  // HyperScript syntax returns an ElementNode<T> object, with typed properties
  let svgNode = h("svg", { key: 2, currentScale: 1 }, h("path"));
  ...
  // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
  let jsxNode = <svg key={2} currentScale={1}><path /></svg>;
  let jsxNodeType = jsxNode.type as string;
  let jsxNodeProps = jsxNode.props as PetitDom.Props<SVGSVGElement>;
...
export function testFunctionComponent() {
  ...
  let node = h(FunctionComponent, { key: "1" });
  ...
  // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
  let jsxNode = <FunctionComponent key="1" />;
  let jsxNodeType = jsxNode.type as PetitDom.FunctionComponent<{}>;
  let jsxNodeProps = jsxNode.props as PetitDom.IntrinsicProps;
...
export function testFunctionComponentWithProps() {
  ...
  // HyperScript syntax returns a FunctionComponentNode<T> object, with typed properties
  let node = h(FunctionComponentWithProps, { name: "xyz", count: 123, onSomeEvent: eventHandler });
  ...
  // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
  let jsxNode = <FunctionComponentWithProps name="xyz" count={123} onSomeEvent={eventHandler} />;
  let jsxNodeType = jsxNode.type as PetitDom.FunctionComponent<CustomProps>;
  let jsxNodeProps = jsxNode.props as CustomProps;
...
export function testFunctionComponentWithChildren() {
  function FunctionComponentWithChildren(props: CustomProps, content: PetitDom.Content[]): JSX.Element {
    const { name, count, onSomeEvent } = props;
...
export function testComponentClass() {
  class ComponentClass {
    ...
    public patch(element: Element, newProps: object, oldProps: object, newContent: PetitDom.VNode[], oldContent: PetitDom.VNode[]): Element {
      patch(
  ...
  let node = h(ComponentClass, { key: "1" });
  ...
  // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
  let jsxNode = <ComponentClass key="1" />;
  let jsxNodeType = jsxNode.type as PetitDom.ComponentClass<{}>;
  let jsxNodeProps = jsxNode.props as PetitDom.IntrinsicProps;
...
export function testComponentClassWithProps() {
  class ComponentClassWithProps {
    public props: CustomProps;

    public constructor(props: CustomProps) {
      this.props = props;
    }

    public mount(props: CustomProps): Element {
      const { name, count, onSomeEvent } = props;
      return mount(<div className={name} tabIndex={count} onclick={onSomeEvent} />);
    }

    public patch(element: Element, newProps: CustomProps, oldProps: CustomProps, newContent: PetitDom.VNode[], oldContent: PetitDom.VNode[]): Element {
      patch(
        <div {...oldProps}>{oldContent}</div>,
        <div {...newProps}>{newContent}</div>
      );
  ...
  // HyperScript syntax returns a ComponentClassNode<T> object, with typed properties
  let node = h(ComponentClassWithProps, { name: "xyz", count: 123, onSomeEvent: eventHandler });
  ...
  // JSX syntax returns a VNode object, so the "type" and "props" properties are "any"
  let jsxNode = <ComponentClassWithProps name="xyz" count={123} onSomeEvent={eventHandler} />;
  let jsxNodeType = jsxNode.type as PetitDom.ComponentClass<CustomProps>;
  let jsxNodeProps = jsxNode.props as CustomProps;
...
export function testComponentClassWithChildren() {
  class ComponentClassWithChildren {
    ...
    public mount(props: CustomProps, content: PetitDom.Content[]): Element {
      const { name, count, onSomeEvent } = props;
      return mount(
