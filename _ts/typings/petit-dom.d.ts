...
declare module "petit-dom" {
  ...
  namespace PetitDom {
    ...
    interface FunctionComponent<P extends ComponentProps> {
      (props: P, content: Content[]): FunctionComponentNode<P>;
      shouldUpdate?: ShouldUpdate<P>;
    }

    interface ComponentClass<P extends ComponentProps> {
      new(props: P, content: Content[]): Component<P>;
    }

    interface Component<P extends ComponentProps> {
      mount(props: P, content: VNode[]): Element;
      patch(element: Element, newProps: P, oldProps: P, newContent: VNode[], oldContent: VNode[]): Element;
  ...
  global {
    namespace JSX {
      ...
      type IntrinsicElements = {
        ...
        {
          content?: PetitDom.Content | PetitDom.Content[];
        };
      };
    }
  }
