/*!
 * My Repos v0.3.0 (November 18th 2018)
 * 
 * https://myrepos.io/
 * 
...
},{"../state-store":20,"../util":22,"./api-response":3}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const util_1 = require("../util");
...
},{"../util":22,"./api-error":2}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./repo-list":11}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const state_store_1 = require("../state-store");
const util_1 = require("../util");
...
},{"../state-store":20,"../util":22,"./account-item":4}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const state_store_1 = require("../state-store");
...
},{"../state-store":20}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const state_store_1 = require("../state-store");
...
class App extends React.Component {
    ...
    render() {
        return [
            ...
            React.createElement(options_1.Options, { key: "options" }),
...
exports.App = App;
},{"../state-store":20,"./account-list":5,"./first-time":8,"./options":9,"./page-header":10}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const state_store_1 = require("../state-store");
const util_1 = require("../util");
...
},{"../state-store":20,"../util":22,"./add-account":6}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const state_store_1 = require("../state-store");
function Options() {
    ...
    return (React.createElement("div", { className: "responsive-container" },
        React.createElement("aside", { id: "options" },
            hasForks &&
                React.createElement("a", { id: "toggle_forks", href: `#forks=${showForks ? "hide" : "show"}`, onClick: handleOptionClick },
                    showForks ? "hide" : "show",
                    " forks"),
            hasArchived &&
                React.createElement("a", { id: "toggle_archived", href: `#archived=${showArchived ? "hide" : "show"}`, onClick: handleOptionClick },
...
},{"../state-store":20}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const state_store_1 = require("../state-store");
const util_1 = require("../util");
...
},{"../state-store":20,"../util":22,"./add-account":6}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
    ...
    return (React.createElement("li", { key: repo.name, className: `repo ${repo.fork ? "forked" : ""} ${repo.archived ? "archived" : ""}` },
        ...
        React.createElement("nav", { className: "badges" },
            ...
            React.createElement("a", { href: `${repo.html_url}/stargazers`, className: `badge ${repo.stargazers_count ? "badge-ok" : ""} stars` },
                React.createElement(Octicon, { name: "star" }),
            ...
            React.createElement("a", { href: `${repo.html_url}/watchers`, className: `badge ${repo.watchers_count ? "badge-ok" : ""} watchers` },
                React.createElement(Octicon, { name: "eye" }),
            ...
            React.createElement("a", { href: `${repo.html_url}/issues`, className: `badge ${repo.open_issues_count ? "badge-warning" : "badge-ok"} issues` },
                React.createElement(Octicon, { name: repo.open_issues_count ? "issue-opened" : "issue-closed" }),
...
function Octicon({ name }) {
    ...
    return React.createElement("svg", Object.assign({}, icon.options, { dangerouslySetInnerHTML: { __html: icon.path } }));
}
function DependencyBadge(props) {
    ...
    return (React.createElement("a", { href: repo.dependencies.html_url, className: `badge ${hasError ? "badge-error" : "badge-ok"} dependencies` },
        React.createElement(Octicon, { name: "package" }),
...
},{"../state-store":20,"octicons":25}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
},{"../api-client/api-client":1,"../api-client/api-error":2,"./github-account":12,"./github-repo":13}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./components/app":7}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const util_1 = require("../util");
class AppState {
 ...
 * multiple times.
 */
async function fetchData(account, update) {
...
},{"../github":15,"../github/github-account":12}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const github_account_1 = require("../github/github-account");
const util_1 = require("../util");
...
},{"../github/github-account":12,"../util":22}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const state_store_1 = require("./state-store");
/**
...
},{"./state-store":21}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const github_account_1 = require("../github/github-account");
...
class StateStore extends EventTarget {
        ...
        if (hashState.accounts) {
            ...
            for (let hashAccount of hashAccounts) {
                ...
                if (account) {
                    ...
                    fetch_data_1.fetchData(hashAccount, (updated) => this.updateAccount(updated))
                        .catch((error) => {
    ...
    async addAccount(login) {
        ...
        // Fetch the account's data from GitHub, David-DM, etc.
        await fetch_data_1.fetchData(account, (updated) => this.updateAccount(updated));
    }
    /**
...
},{"../github/github-account":12,"./app-state":17,"./fetch-data":18,"./hash":19}],22:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./build/data.json":24,"object-assign":23}]},{},[16])
