/*!
 * My Repos v0.4.0 (November 23rd 2018)
 * 
 * https://myrepos.io/
 * 
...
},{"../state-store":24,"../util":26,"./api-response":3}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const util_1 = require("../util");
...
},{"../util":26,"./api-error":2}],4:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const petit_dom_1 = require("petit-dom");
const repo_list_1 = require("./repo-list");
function AccountItem(props) {
    let { account } = props;
    return (petit_dom_1.h("section", { key: account.login, className: "account" },
        petit_dom_1.h("header", null,
            petit_dom_1.h("h1", null,
                petit_dom_1.h("a", { href: account.html_url },
                    account.avatar_url && petit_dom_1.h("img", { src: account.avatar_url, className: "avatar" }),
                    account.name))),
        petit_dom_1.h(AccountItemContents, Object.assign({}, props))));
}
exports.AccountItem = AccountItem;
function AccountItemContents(props) {
    let { account } = props;
    if (account.repos.length > 0) {
        return petit_dom_1.h(repo_list_1.RepoList, { account: account });
    }
    else if (account.error) {
        return (petit_dom_1.h("div", { className: "error" },
            petit_dom_1.h("div", { className: "error-message" }, account.error)));
    }
    else if (account.loading) {
        return (petit_dom_1.h("div", { className: "loading" },
            petit_dom_1.h("div", { className: "loading-message" }, "Loading...")));
    }
    else {
        return (petit_dom_1.h("div", { className: "no-repos" },
            petit_dom_1.h("div", { className: "empty-message" }, "There are no repos to show")));
    }
}

},{"./repo-list":12,"petit-dom":30}],5:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const petit_dom_1 = require("petit-dom");
const state_store_1 = require("../state-store");
...
function AccountList() {
    ...
    return (petit_dom_1.h("main", { id: "account_list", className: util_1.accountCountCssClass(accounts) },
        petit_dom_1.h("div", { className: "responsive-container" }, accounts.map((account) => petit_dom_1.h(account_item_1.AccountItem, { account: account })))));
}
exports.AccountList = AccountList;

},{"../state-store":24,"../util":26,"./account-item":4,"petit-dom":30}],6:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const petit_dom_1 = require("petit-dom");
const state_store_1 = require("../state-store");
const component_1 = require("./component");
class AddAccount extends component_1.Component {
    constructor() {
        super(...arguments);
        this.login = "";
    ...
    render() {
        ...
        let { login } = this;
        return (petit_dom_1.h("form", { className: "add-account form", onsubmit: this.handleSubmit },
            petit_dom_1.h("dl", { className: "form-group" },
                petit_dom_1.h("dt", { className: "input-label" },
                    petit_dom_1.h("label", { htmlFor: "repo_owner" }, "GitHub Username")),
                petit_dom_1.h("dd", { className: "input-field" },
                    petit_dom_1.h("input", { type: "text", name: "account_name", className: "form-control short", maxLength: 100, autofocus: true, autocapitalize: "off", autocomplete: "on", spellcheck: false, placeholder: "GitHub Username", value: login, onchange: this.handleChange }))),
            petit_dom_1.h("button", { type: "submit", className: "btn btn-primary" }, submitButtonText || "Add")));
    }
}
exports.AddAccount = AddAccount;

},{"../state-store":24,"./component":8,"petit-dom":30}],7:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const petit_dom_1 = require("petit-dom");
...
class App extends component_1.Component {
    render() {
        return (petit_dom_1.h("body", null,
            petit_dom_1.h(page_header_1.PageHeader, { key: "page_header" }),
            petit_dom_1.h(options_1.Options, { key: "options" }),
            petit_dom_1.h(account_list_1.AccountList, { key: "account_list" }),
            petit_dom_1.h(first_time_1.FirstTime, { key: "first_time" })));
    }
}
exports.App = App;

},{"./account-list":5,"./component":8,"./first-time":9,"./options":10,"./page-header":11,"petit-dom":30}],8:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const petit_dom_1 = require("petit-dom");
class Component {
    ...
    mount() {
        ...
        let domNode = petit_dom_1.mount(this._vnode);
        return domNode;
    }
    patch(element, props, old, content) {
        this._props = props;
        this._content = content;
        this.updateUI();
        return element;
    ...
    unmount() {
        petit_dom_1.unmount(this._vnode);
    }
    updateUI() {
        let oldVNode = this._vnode;
        let newVNode = this._vnode = this.render();
        petit_dom_1.patch(newVNode, oldVNode);
    }
}
exports.Component = Component;

},{"petit-dom":30}],9:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const petit_dom_1 = require("petit-dom");
const state_store_1 = require("../state-store");
...
function FirstTime() {
    let { accounts } = state_store_1.stateStore.state;
    return (petit_dom_1.h("aside", { id: "first_time", className: util_1.accountCountCssClass(accounts) },
        petit_dom_1.h("div", { className: "responsive-container" },
            petit_dom_1.h("div", { className: "welcome-message" },
                petit_dom_1.h("h3", null, "Hi! \uD83D\uDC4B Enter your GitHub username to get started"),
                petit_dom_1.h(add_account_1.AddAccount, { submitButtonText: "Show My Repos" })))));
}
exports.FirstTime = FirstTime;

},{"../state-store":24,"../util":26,"./add-account":6,"petit-dom":30}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const petit_dom_1 = require("petit-dom");
const state_store_1 = require("../state-store");
...
function Options() {
    ...
    return (petit_dom_1.h("div", { className: "responsive-container" },
        petit_dom_1.h("aside", { id: "options" },
            hasForks ?
                petit_dom_1.h("a", { id: "toggle_forks", href: `#forks=${showForks ? "hide" : "show"}`, onclick: handleOptionClick },
                    showForks ? "hide" : "show",
                    " forks") : util_1.NULL,
            hasArchived ?
                petit_dom_1.h("a", { id: "toggle_archived", href: `#archived=${showArchived ? "hide" : "show"}`, onclick: handleOptionClick },
                    showArchived ? "hide" : "show",
                    " archived") : util_1.NULL)));
}
...
},{"../state-store":24,"../util":26,"petit-dom":30}],11:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const petit_dom_1 = require("petit-dom");
const state_store_1 = require("../state-store");
...
function PageHeader() {
    let { accounts } = state_store_1.stateStore.state;
    return (petit_dom_1.h("header", { id: "page_header", className: util_1.accountCountCssClass(accounts) },
        petit_dom_1.h("div", { className: "responsive-container" },
            petit_dom_1.h("img", { className: "logo", src: "img/logo.png", alt: "logo image" }),
            petit_dom_1.h("h1", null, "My GitHub Repos"),
            petit_dom_1.h("h2", null, "All your GitHub repos on one page"),
            petit_dom_1.h(add_account_1.AddAccount, null))));
}
exports.PageHeader = PageHeader;

},{"../state-store":24,"../util":26,"./add-account":6,"petit-dom":30}],12:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
function RepoList(props) {
    ...
    return (petit_dom_1.h("ul", { className: "repo-list" }, repos.map((repo) => petit_dom_1.h(RepoItem, Object.assign({ repo: repo }, props)))));
}
exports.RepoList = RepoList;
function RepoItem(props) {
    let { repo } = props;
    return (petit_dom_1.h("li", { key: repo.name, className: `repo ${repo.fork ? "forked" : ""} ${repo.archived ? "archived" : ""}` },
        petit_dom_1.h("h2", null,
            petit_dom_1.h("a", { href: repo.html_url }, repo.name)),
        repo.description && petit_dom_1.h("h3", null, repo.description),
        petit_dom_1.h("nav", { className: "badges" },
            petit_dom_1.h("a", { href: `${repo.html_url}/network/members`, className: `badge ${repo.forks_count ? "badge-ok" : ""} forks` },
                petit_dom_1.h(Octicon, { name: "repo-forked" }),
                petit_dom_1.h("span", { className: "badge-label" }, "Forks"),
                petit_dom_1.h("span", { className: "badge-count" }, String(repo.forks_count))),
            petit_dom_1.h("a", { href: `${repo.html_url}/stargazers`, className: `badge ${repo.stargazers_count ? "badge-ok" : ""} stars` },
                petit_dom_1.h(Octicon, { name: "star" }),
                petit_dom_1.h("span", { className: "badge-label" }, "Stars"),
                petit_dom_1.h("span", { className: "badge-count" }, String(repo.stargazers_count))),
            petit_dom_1.h("a", { href: `${repo.html_url}/watchers`, className: `badge ${repo.watchers_count ? "badge-ok" : ""} watchers` },
                petit_dom_1.h(Octicon, { name: "eye" }),
                petit_dom_1.h("span", { className: "badge-label" }, "Watchers"),
                petit_dom_1.h("span", { className: "badge-count" }, String(repo.watchers_count))),
            petit_dom_1.h("a", { href: `${repo.html_url}/issues`, className: `badge ${repo.open_issues_count ? "badge-warning" : "badge-ok"} issues` },
                petit_dom_1.h(Octicon, { name: repo.open_issues_count ? "issue-opened" : "issue-closed" }),
                petit_dom_1.h("span", { className: "badge-label" }, "Issues"),
                petit_dom_1.h("span", { className: "badge-count" }, String(repo.open_issues_count))),
...
function Octicon({ name }) {
    ...
    return petit_dom_1.h("svg", Object.assign({}, icon.options, { innerHTML: icon.path }));
}
function DependencyBadge(props) {
    ...
    if (repo.dependencies.total === 0) {
        ...
        return util_1.NULL; // tslint:disable-line:no-null-keyword
    }
    let hasError;
    let label;
    let count;
    ...
    return (petit_dom_1.h("a", { href: repo.dependencies.html_url, className: `badge ${hasError ? "badge-error" : "badge-ok"} dependencies` },
        petit_dom_1.h(Octicon, { name: "package" }),
        petit_dom_1.h("span", { className: "badge-label" }, label),
        petit_dom_1.h("span", { className: "badge-count" }, `${count} / ${repo.dependencies.total}`)));
}

},{"../state-store":24,"../util":26,"octicons":29,"petit-dom":30}],13:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
},{"../package-registry/dependencies":18}],15:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../api-client/api-client":1,"../api-client/api-error":2,"../api-client/api-response":3,"./github-account":13,"./github-repo":14}],16:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./github":15}],17:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const petit_dom_1 = require("petit-dom");
const app_1 = require("./components/app");
let app = petit_dom_1.h(app_1.App, null);
let element = petit_dom_1.mount(app);
document.body = element;

},{"./components/app":7,"petit-dom":30}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
class Dependencies {
    constructor() {
...
},{"./package-registry":20}],20:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const api_client_1 = require("../api-client/api-client");
const api_response_1 = require("../api-client/api-response");
...
},{"../api-client/api-client":1,"../api-client/api-response":3,"./dependencies":18}],21:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const util_1 = require("../util");
class AppState {
...
},{"../github":16,"../github/github-account":13,"../github/github-repo":14,"../package-registry":19}],23:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const github_account_1 = require("../github/github-account");
const util_1 = require("../util");
...
},{"../github/github-account":13,"../util":26}],24:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const state_store_1 = require("./state-store");
/**
...
},{"./state-store":25}],25:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const github_account_1 = require("../github/github-account");
...
},{"../github/github-account":13,"./app-state":21,"./fetch-data":22,"./hash":23}],26:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./build/data.json":28,"object-assign":27}],30:[function(require,module,exports){
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports) :
	typeof define === 'function' && define.amd ? define(['exports'], factory) :
	(factory((global.petitDom = global.petitDom || {})));
...
function patch(newch, oldch, parent) {
  ...
  if ((t1 = oldch._text) != null && (t2 = newch._text) != null) {
    ...
    if (isComponent(type)) {
      ...
      var delayedProps = setAttributes(childNode, newch.props, oldch.props, newch.isSVG);
